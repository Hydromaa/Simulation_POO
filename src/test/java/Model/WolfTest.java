...
class WolfTest {
    ...
    void wolfMortSiEnergieZero() {
        // Arrange
        Wolf wolf = new Wolf(30, 2, 2, 100, 150, 3, 100, 50);
        // Act
        wolf.setEnergy(0);
        // Assert
    ...
    void constructeurInvalideEnergyMax() {
        ...
        assertThrows(IllegalArgumentException.class, ()
                -> new Wolf(30, 2, 2, 100, -1, 3, 100, 50)
        );
    }
    ...
    void sheepIsAliveAfterEat() {
        ...
        Wolf wolf = new Wolf(50, 5, 5, 20, 150, 3, 100, 50);
        Sheep sheep = new Sheep(20, 5, 6, 80, 100, 2, 70, 30);
